...
on public.customers;
drop policy if exists "Users can view own customer"
on public.customers;
...
drop policy if exists "Customers can create own customer record"
on public.customers;
...
drop policy if exists "Customers can update own customer record"
on public.customers;
...
drop policy if exists "Users can view own billing events"
on public.billing_events;
